 ...
 * Ждать условия.
 *
 * Предел щедрый намеренно: проверки гоняются в живом браузере, где вкладка
 * делит время с отрисовкой экранов и со звуковым движком. Меньший предел
 * ловил не ошибку обмена, а занятость машины — и падал через раз на ровном
 * месте.
 */
async function дождаться(условие, предел = 5000) {
