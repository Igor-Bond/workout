...
await import('./suites/scale.test.js');
...
await import('./suites/ai.test.js');
...
await import('./suites/ical.test.js');
await import('./suites/progress.test.js');
...
await import('./suites/digest.test.js');
await import('./suites/pace.test.js');
await import('./suites/css.test.js');
await import('./suites/layout.test.js');
