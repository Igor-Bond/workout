...
export const exercises = {
    ...
    async render() {
        ...
        return ui.html`
            ...
            <!--
                Поиск стоит вплотную к списку (§5.3, Р-126).

                Появляется он, только когда список правда длинный: над пятью
                строками он занимал бы место и ничего не решал.

                А стоял он выше кнопок «Добавить упражнение» и «Доли своего
                веса» — то есть между полем и списком, который оно отбирает,
                вклинивалась кнопка, к поиску отношения не имеющая. На
                телефоне, когда открыта клавиатура, видимой остаётся полоска в
                несколько строк, и одну из них забирала она.
            -->
