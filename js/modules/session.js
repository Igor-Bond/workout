...
function restOf(exerciseId) {
    /*
     * Пауза дня из плана старше собственной паузы упражнения (§56.2).
     *
     * Одно и то же упражнение стоит в днях с разной паузой: у шестисетового
     * дня десять минут, у двенадцатисетового пять. Своя длительность
     * упражнения такого различия не знает — она одна на все дни, — а
     * человек, объявивший паузу в плане, объявил её для этого дня.
     */
