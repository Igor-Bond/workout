...
function restOf(exerciseId) {
     ...
     * 2. пауза дня из плана (§56.2): одно упражнение стоит в днях с разной
     *    паузой, и своя длительность упражнения такого различия не знает;
     * 3. своя длительность упражнения — сказанное о нём когда-то;
     * 4. последняя пауза этой тренировки — сегодняшний темп;
     * 5. общая настройка.
     */
