 ...
 */
function startBlock(last, templates, suggestion, names, due, frequent, очередь) {
     ...
     * делали вовремя.
     *
     * Подпись — дни, а не множитель: «5 дней» человек примеряет на себя
