    ...
    async render() {
        ...
        return ui.html`
            ...
            <div class="card">
                ...
                <!--
                    Имя у поля своё, а не из подсказки внутри (Р-150).

                    Подсказка — это образец первой строки, и стоит она ровно
                    до тех пор, пока поле пусто. Читалке нужно имя, которое
                    никуда не девается.
                -->
                <textarea id="plan-text" class="report-text" rows="12"
                          aria-label="${t('Черновик плана')}"
