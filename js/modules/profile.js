        ...
        return ui.html`
            ...
            <div class="card">
                ...
                ${!fullscreen.byManifest && install.installed ? ui.html`
                    <p class="hint">
                        ${t('Приложение установлено в оконном режиме — системная полоса снизу остаётся. Чтобы она пропала совсем, удалите значок с домашнего экрана и добавьте заново: во весь экран приложение разворачивается при установке.')}
                    </p>
                ` : ''}
            </div>
            ...
            <div class="card">
                ...
                -->
                ${appleMobile() ? '' : ui.raw(toggle('restVibration', t('Вибрация'),
                    t('По окончании отдыха, а также коротким откликом на записанный подход, утверждённый план и завершённую тренировку')))}
            ...
            <div class="card">
                ...
                <p class="hint">
                    ${t('Файл на диске не зависит от облака и учётной записи — это копия, которая целиком в ваших руках.')}
                </p>
