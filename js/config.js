...
const DEFAULTS = {
     ...
     *
     * По умолчанию выключен: он прячет и часы со строкой состояния, а это
     * решение за пользователя. Нужен там, где системная панель навигации
     * светлая и портит тёмный экран снизу.
     */
    fullscreen: false,
