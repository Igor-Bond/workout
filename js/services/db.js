...
export const dbService = {
     ...
     * остальное (§36).
     *
     * Заметки при свёртке пропадают, и это цена, названная вслух: у суммы
     * пяти приёмов пищи нет одной заметки, а склеенная из пяти — не заметка,
     * а мусор.
     */
    async foldIntake({ before }) {
        ...
        for (const записи of поДням.values()) {
            ...
            кпереписи.push({ ...главная, kcal: Math.round(сумма), note: '', updatedAt: now });
