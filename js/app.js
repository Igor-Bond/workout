...
export const app = {
    ...
    async render() {
        ...
        /*
         * «Загрузка…» — только при переходе на другой экран.
         *
         ...
         * Стирать ради этого содержимое и подставлять заглушку значит
         * мигать: на телефоне отрисовка занимает заметное время, и человек
         * видит вспышку «Загрузка…» вместо экрана, на который смотрел.
         *
         * Старая разметка остаётся на месте до готовности новой. При
         * переходе она бы вводила в заблуждение — там заглушка честнее.
         */
        if (navigated) {
