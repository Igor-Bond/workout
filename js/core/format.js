 ...
 */
const WORDS = {
    set:      { ru: ['подход', 'подхода', 'подходов'],             en: ['set', 'sets'] },
    rep:      { ru: ['повторение', 'повторения', 'повторений'],    en: ['rep', 'reps'] },
    exercise: { ru: ['упражнение', 'упражнения', 'упражнений'],    en: ['exercise', 'exercises'] },
    workout:  { ru: ['тренировка', 'тренировки', 'тренировок'],    en: ['workout', 'workouts'] },
    day:      { ru: ['день', 'дня', 'дней'],                       en: ['day', 'days'] },
    minute:   { ru: ['минута', 'минуты', 'минут'],                 en: ['minute', 'minutes'] }
};
...
export const format = {
     ...
     *
     * По-русски запятая — так пишут и так же выглядит на клавиатуре
     * телефона. По-английски точка: «62,5» англоязычный читает как список
     * из двух чисел.
     */
    point() {
        return i18n.lang === 'en' ? '.' : ',';
