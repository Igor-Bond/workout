...
export const chart = {
     ...
     */
    line(series = [], { height = 160, marks = [], unit = '', minSpan = 0, scale = Boolean(unit) } = {}) {
         ...
         *
         * Десятой доли хватает, пока поле охватывает единицы: у веса это
         * 92,9. Но у отношения талии к росту всё поле — шесть сотых, и обе
         * подписи округлялись в «0,5»: шкала называла один и тот же край
         * дважды.
         *
         * И знаков поровну у обоих концов. Считая по каждому числу
         * отдельно, шкала подписывалась «28,2» и «27» — так выглядит не пара
         * границ, а два числа разной точности, взятые откуда попало.
         */
