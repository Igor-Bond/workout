        ...
        },
        {
            ...
            blocks: [
                ...
                { rows: [
                    ...
                    ['Следом', 'Плашки под карточкой — остальная очередь. Подпись говорит, сколько дней прошло с прошлого раза, и по ней же выстроен ряд. Промежуток берётся из вашей же истории за последние восемь недель и пересчитывается сам: станете делать реже — порог поднимется. Но прежде опоздания смотрятся мышцы: состав, чья группа работала недавно, уходит вниз, как бы он ни опаздывал. Тренировки типа «Зарядка» в очереди не участвуют — их делают каждое утро и без напоминания; для них есть свой раздел «Чаще всего» ниже. Там плашка не исчезает после выполнения, а метится цветом: зелёная рамка — сегодня уже сделано, тёплая — ещё нет.'],
