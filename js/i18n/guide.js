    ...
    sections: [
        ...
        },
        {
            ...
            blocks: [
                ...
                { sounds: [
                    ['count', 'Three-two-one countdown', 'Three short clicks before every change — both before work starts and before it ends.'],
                    ['go', 'Work starts', 'One long steady tone. Go.'],
                    ['pulse', 'Pulse during work', 'A quiet low sound every five seconds: it confirms that work is running, not rest. No need to look at the phone.'],
                    ['rest', 'Work ends', 'Two tones down. The rule is simple: up means begin, down means stop.'],
                    ['round', 'Round ends', 'Three tones down. A long rest between rounds follows.'],
                    ['done', 'Program ends', 'Four notes up with a long last one. It lasts longer than any other — impossible to confuse.']
                ] },
    ...
    sections: [
        ...
        },
        {
            ...
            blocks: [
                ...
                { sounds: [
                    ['count', 'Countdown drei-zwei-eins', 'Drei kurze Klicks vor jedem Wechsel — sowohl vor dem Beginn der Arbeit als auch vor ihrem Ende.'],
                    ['go', 'Arbeit beginnt', 'Ein langer gleichmäßiger Ton. Los.'],
                    ['pulse', 'Puls während der Arbeit', 'Ein leiser tiefer Ton alle fünf Sekunden: er bestätigt, dass Arbeit läuft und keine Pause. Aufs Handy schauen musst du nicht.'],
                    ['rest', 'Arbeit endet', 'Zwei Töne abwärts. Die Regel ist einfach: aufwärts heißt anfangen, abwärts heißt aufhören.'],
                    ['round', 'Runde endet', 'Drei Töne abwärts. Danach kommt die lange Pause zwischen den Runden.'],
                    ['done', 'Programm endet', 'Vier Töne aufwärts mit langem letztem Ton. Es dauert länger als alle anderen — verwechseln kann man es nicht.']
                ] },
